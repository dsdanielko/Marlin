...
#define INPUT_SHAPING_Y //DK
    ...
    #define SHAPING_FREQ_X  33.22          // (Hz) The default dominant resonant frequency on the X axis. //DK
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  42.73          // (Hz) The default dominant resonant frequency on the Y axis. //DK
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     65  // (mm) Load length of filament, from extruder gear to nozzle. //DK
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         20  // (mm) Length to extrude after loading. //DK
