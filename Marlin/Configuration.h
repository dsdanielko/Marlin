...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  31.29 //DK
    #define DEFAULT_Ki   3.79 //DK
    #define DEFAULT_Kd  64.58 //DK
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 101.03 //DK
  #define DEFAULT_bedKi 10.87 //DK
  #define DEFAULT_bedKd 626.21 //DK
...
#define EXTRUDE_MAXLENGTH 600 //DK
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 406.99 } //DK
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 40, 40, 0.6, 10 } // ...or, set your own edit limits //DK
  #endif
#endif
 ...
 */
#define S_CURVE_ACCELERATION //DK
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -6, -0.4 } //DK

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 15 //DK
...
#define Y_BED_SIZE 220 //DK

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -13.5 //DK
#define Z_MIN_POS 0
