...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.24 //DK
    #define DEFAULT_Ki   2.07 //DK
    #define DEFAULT_Kd  59.59 //DK
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.73 //DK
  #define DEFAULT_bedKi 23.99 //DK
  #define DEFAULT_bedKd 432.41 //DK
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 420 } //DK
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 200, 10000 } //DK
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 30, 30, 1, 10 } // ...or, set your own edit limits //DK
  #endif
#endif
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //DK

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //DK
...
#define PROBING_MARGIN 10 //DK

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (160*60) //DK

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) //DK
...
#define DELAY_BEFORE_PROBING 100  // (ms) To prevent vibrations from triggering piezo sensors //DK
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //DK
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500. //DK
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 //DK

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR //DK
...
#define AUTO_BED_LEVELING_BILINEAR //DK
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //DK
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 10.0 // (mm) Default fade height. //DK
  #endif
   ...
   */
  #define G26_MESH_VALIDATION //DK
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.4  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2  // (mm) Default layer height for G26.
    #define MESH_TEST_HOTEND_TEMP  210    // (°C) Default nozzle temperature for G26. //DK
...
//#define LCD_BED_TRAMMING //DK

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 35, 10, 10, 10 } // (mm) Left, Front, Right, Back insets //DK
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between leveling points
  //#define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE //DK
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //DK
#define INDIVIDUAL_AXIS_HOMING_SUBMENU //DK
